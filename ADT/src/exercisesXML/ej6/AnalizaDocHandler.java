...
/**
 * Para poder hacer algo útil con los datos XML según se analizan, debemos usar
 * un manejador de contenido. Un manejador es una clase con una serie de
 * métodos. Estos mñetodos se ejecutan cuando el analizador detecta determinados
 * eventos que se producen al leer un documento (empieza el documento, se abre
 * un elemento, se cierra, etc.). añadimos el manejador, que implementa
 * ContentHandler. Los métos se sobreescriben con el código apropiado para el
 * programa que estemos realizando en cada momento, en este caso añadiremos algo
 * de código a los métodos del manejador para ilustrar su funcionamiento.
 * Simplemente escribiremos mensajes por la consola cuando se detecten los
 * eventos.:
 */
public class AnalizaDocHandler implements ContentHandler {
	...
	public void startPrefixMapping(String prefix, String uri) throws SAXException {
		...
		System.out.println("Comienza el uso del prefijo " + (prefix.equals("") ? "(vacio)" : prefix)
	...
	public void endPrefixMapping(String prefix) throws SAXException {
		// TODO Auto-generated method stub
		System.out.println("Termina el uso del prefijo " + (prefix.equals("") ? "(vacio)" : prefix));
	}
	...
	public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
		...
		if (!uri.equals("")) {
			System.out.println(" URI " + uri + " (" + qName + ")");
		} else {
			System.out.println(" sin espacio de nombres asociado");
		}
		for (int i = 0; i < atts.getLength(); i++) {
			System.out.println("  Atributo: " + atts.getLocalName(i) + "=" + atts.getValue(i));
		}
	}
